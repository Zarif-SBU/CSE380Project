...
import PauseMenuScene from "../InBetweenScenes/PauseMenuScene";

export default class ControlScene extends Scene {
    ...
    public handleEvent(event: GameEvent): void {
        if (event.type === "back"){
            this.sceneManager.changeToScene(PauseMenuScene);
        }
    }
}
*/