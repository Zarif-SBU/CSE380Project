...
export default class Wolfbehavior extends NPCBehavior {
    ...
    protected initializeStatuses(): void {
        ...
        let allyBattlerFinder = new BasicFinder<Battler>(null, BattlerHealthFilter(0, this.owner.maxHealth), AllyFilter(this.owner), BattlerGroupFilter([this.owner.battleGroup]), RangeFilter(scene.getBattlers()[0], 0, 800*800));
