...
//     public constructor(scene: Scene, owner: Health & Positioned & Unique, layer: string, options: HealthBarOptions, viewportCenter: Vec2) {
//         this.scene = scene;
//         this.layer = layer;
//         this.owner = owner;
...
//         this.healthBar = <Label>this.scene.add.uiElement(UIElementType.LABEL, layer, {position: this.viewportCenter.clone().add(this.offset), text: ""});
//         this.healthBar.size.copy(this.size);
//         this.healthBar.backgroundColor = Color.RED;

//         this.healthBarBg = <Label>this.scene.add.uiElement(UIElementType.LABEL, layer, {position: this.viewportCenter.clone().add(this.offset), text: ""});
...
//         this.healthBar.position.copy(this.viewportCenter).add(this.offset);
//         this.healthBarBg.position.copy(this.viewportCenter).add(this.offset);
